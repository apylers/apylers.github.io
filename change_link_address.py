...
def get_icon_unicode(all_icons):
    ...
    i = 0
    for data in fontawesome[2]['data']:
...
def subset_font(orginal_font_path, output_font_path, text="", unicodes="", flavor="", no_subset_tables=""):
    ...
    for exclude_dir in exclude_dir_list:
        ...
        for file_name in file_list:
            ...
            if os.path.splitext(file_path)[1] == '.html':
                content, code_content, fas_icons, fab_icons = get_text_and_icon(file_path)
                all_content |= content
...
subset_font(original_font_dir + 'SourceHanMonoSC-Bold.otf', generate_font_dir + 'SourceHanMonoSC-Bold.woff2',
            text=''.join(sorted(all_code)), flavor="woff2")

subset_font(original_font_dir + 'SourceHanSerifSC-Regular.otf', generate_font_dir + 'SourceHanSerifSC-Regular.woff2',
            text=''.join(sorted(all_content)), flavor="woff2")
subset_font(original_font_dir + 'SourceHanSerifSC-Bold.otf', generate_font_dir + 'SourceHanSerifSC-Bold.woff2',
            text=''.join(sorted(all_content)), flavor="woff2")

subset_font(original_font_dir + 'Font-Awesome-solid.woff2', generate_font_dir + 'Font-Awesome-solid.woff2',
            unicodes=','.join(get_icon_unicode(all_fas)), flavor="woff2", no_subset_tables="+=FFTM")
subset_font(original_font_dir + 'Font-Awesome-brands.woff2', generate_font_dir + 'Font-Awesome-brands.woff2',
            unicodes=','.join(get_icon_unicode(all_fab)), flavor="woff2", no_subset_tables="+=FFTM")
