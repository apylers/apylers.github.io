...
;(function ($) {
    ...
    var headerCoverResize = function () {
        ...
        var imgHeight = headerCoverImage.height;
        ...
        var resizeCover = function () {
            ...
            if (containerWidth >= 855) {
                ...
                if (imgWidth <= containerWidth && imgHeight <= containerHeight) {
                    headerCover.css("background-size", "auto " + imgHeight + "px");
                } else if (imgHeight / imgWidth < containerHeight / containerWidth) {
                    headerCover.css("background-size", "100% auto");
                } else {
                    headerCover.css("background-size", "auto " + containerHeight + "px");
                }
                return;
            }
...
;(function ($) {
    ...
    var PostBottomBar = function () {
        ...
        this.$header = $("#header");
        this.bottomDownCSSClass = "bottom-down";
        this.delta = 1;
        this.lastScrollTop = 0;
    };
    ...
    PostBottomBar.prototype = {
        ...
        swipePostBottomBar: function () {
            ...
            if (
                ...
                this.$postBottomBar.removeClass(this.bottomDownCSSClass);
            } else {
                this.$postBottomBar.addClass(this.bottomDownCSSClass);
            }
            this.lastScrollTop = scrollTop;
        },
    };
...
;(function ($) {
    ...
    SearchModal.prototype = {
        ...
        run: function () {
            ...
            self.$openButton.click(function (e) {
                e.preventDefault();
                self.open();
            });
...
;(function ($) {
    ...
    Sidebar.prototype = {
         ...
         * @return {void}
         */
        resetTocPosition: function () {
            this.$toc.removeClass("pushed");
        },
