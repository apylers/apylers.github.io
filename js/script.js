    ...
    ArchivesFilter.prototype = {
        ...
        showResult: function(numbPosts) {
            if (numbPosts === -1) {
                ...
                this.$archiveResult
                    .html(this.messages.other.replace(/\{n\}/, numbPosts))
                    .show();
            }
        },
        ...
        showPosts: function(date) {
            ...
            $(
                this.postsMonth + "[data-date^=" + date[0] + date[1] + "]"
            ).show();
            $(
                this.postsDay +
                    "[data-date^=" +
...
(function($) {
    ...
    var CategoriesFilter = function(categoriesArchivesElem) {
        ...
        this.$inputSearch = $(categoriesArchivesElem).find(
            "input[name=category]"
        );
    ...
    CategoriesFilter.prototype = {
        ...
        showResult: function(numbCategories) {
            if (numbCategories === -1) {
                ...
                this.$archiveResult
                    .html(this.messages.other.replace(/\{n\}/, numbCategories))
                    .show();
            }
        },
        ...
        showPosts: function(category) {
            ...
            if (self.countCategories(category) > 0) {
                ...
                if (
                    $(categories + "[data-" + self.dataParentCategories + "]")
                        .length
                ) {
                    ...
                    $(categories).each(function() {
                        ...
                        parents = $(this)
                            .attr("data-" + self.dataParentCategories)
                            .split(",");
    ...
    CodeBlockResizer.prototype = {
        ...
        resize: function() {
            ...
            self.$codeBlocks.each(function() {
                ...
                var width =
                    $(this).outerWidth() - $gutter.outerWidth() + codePaddings;
                // apply new width
...
(function($) {
    ...
    PostBottomBar.prototype = {
        ...
        swipePostBottomBar: function() {
            ...
            if (
                this.lastScrollTop > scrollTop &&
                (postFooterOffsetTop + this.$postFooter.height() >
...
(function($) {
    ...
    ShareOptionsBar.prototype = {
        ...
        openShareOptions: function() {
            ...
            if (
                !self.$shareOptionsBar.hasClass("opened") &&
...
(function($) {
    ...
    var TagsFilter = function(tagsArchivesElem) {
        ...
        this.$inputSearch = $(
            tagsArchivesElem + " #filter-form input[name=tag]"
        );
    ...
    TagsFilter.prototype = {
        ...
        showResult: function(numbTags) {
            if (numbTags === -1) {
                ...
                this.$archiveResult
                    .html(this.messages.other.replace(/\{n\}/, numbTags))
                    .show();
            }
        },
        ...
        countTags: function(tag) {
            return $(this.posts + "[data-" + this.dataTag + "*='" + tag + "']")
                .length;
        },
